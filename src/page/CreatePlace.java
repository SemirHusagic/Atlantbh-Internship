...
public class CreatePlace {
	...
	public void addCategory(String catOne) {
	...
	public void addCategory(String catOne, String catTwo) {
        WebElement category = driver.findElement(addcategory);	        
        Actions action = new Actions(driver);
        action.moveToElement(category).click().perform();
	...
	public void addCategory(String catOne, String catTwo, String catThree) {
        WebElement category = driver.findElement(addcategory);	        
        Actions action = new Actions(driver);
        action.moveToElement(category).click().perform();
